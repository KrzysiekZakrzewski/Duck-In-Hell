...
namespace Projectiles.Implementation
{
    ...
    public class DefaultProjectileDataSo : ScriptableObject
    {
        ...
        [field: SerializeField] public float ExpireTime { get; private set; }
        [field: SerializeField] public bool ExpireOnHit { get; private set; }
        [field: SerializeField] public List<ProjectileTargetEffectFactorySo> HitTargetEffectFactories { get; private set; }
    }
}
